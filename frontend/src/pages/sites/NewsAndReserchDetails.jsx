      ...
      <div className="min-h-screen bg-white font-sans selection:bg-[#006699]/10">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 md:py-16 animate-pulse">
          ...
          <div className="text-center max-w-3xl mx-auto mb-10 md:mb-14">
            ...
            <div className="h-8 bg-slate-100 rounded w-3/4 mx-auto mb-4" />
            <div className="h-4 bg-slate-100 rounded w-1/2 mx-auto" />
          </div>

          {/* Banner Skeleton */}
          <div className="w-full mb-12 md:mb-16">
            <div className="aspect-[16/8] md:aspect-[21/9] w-full bg-slate-100 rounded-[24px] md:rounded-[32px]" />
          </div>
  ...
  if (isError || !resource) {
    return (
      <div className="min-h-screen bg-white flex flex-col items-center justify-center p-6 text-center">
        ...
        <Link to="/news-and-research" className="px-5 py-2.5 bg-Primary text-white font-bold rounded-xl">
  ...
  return (
    <div className="min-h-screen bg-white font-sans selection:bg-[#006699]/10">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 md:py-16">
        ...
        <div className="w-full mb-12 md:mb-16">
          <div className="aspect-[16/8] md:aspect-[21/9] w-full relative overflow-hidden rounded-[24px] md:rounded-[32px] shadow-sm bg-slate-50">
            <img
