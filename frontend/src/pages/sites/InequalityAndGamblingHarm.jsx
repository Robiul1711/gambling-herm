    ...
    <>
      <div className="section-padding-x">
        <GamblingCommonBanner
          section="Our work · Inequality"
          title="Gambling harm is not evenly distributed."
          description="Anyone can be harmed by gambling. But the harm tracks the same gradients that every other commercial-determinant harm does, deprivation, ethnicity, gender, neurodivergence, age, intersecting marginalisation. This page sets out how, and why."
          image={bannerImg}
        />
      </div>
      <OurPositionCallout />
