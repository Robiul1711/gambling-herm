...
const SideBar = ({ sidebar, open, setOpen }) => {
 ...
 className={`flex items-center gap-3 px-4 py-2 text-base font-medium transition-colors duration-200 ${
 ...
 {/* Parent link */}
 <div
 className={`flex items-center justify-between px-4 py-2 cursor-pointer w-full transition-all duration-200 ${
 parentActive
 ...
 {/* Sublinks dropdown */}
 <div
 className={`transition-all duration-300 ease-in-out overflow-hidden px-4 bg-white ${
 ...
 {/* Logout */}
 <div className="flex absolute bottom-6 w-[80%] items-center gap-3 cursor-pointer transition px-4 py-2">
 <span>
