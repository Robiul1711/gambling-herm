...
const WorkWithUsSafeguarding = () => {
  return (
    <section className="w-full bg-[#385c66] text-white py-14 md:py-20 px-4">
      <div className="max-w-4xl mx-auto text-center flex flex-col items-center">
        ...
        {/* Description */}
        <p className="text-gray-100 text-base sm:text-lg leading-relaxed font-normal max-w-2xl mb-8">
