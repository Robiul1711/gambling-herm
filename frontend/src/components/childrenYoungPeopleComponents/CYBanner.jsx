...
export default function CYBanner() {
 ...
 <div className="relative w-full max-w-md md:max-w-full overflow-hidden shadow-sm border border-gray-100 dark:border-gray-800 bg-white dark:bg-zinc-900 p-2 sm:p-4">
 <img
 src={image}
