...
export default function PositionStatement() {
  return (
    <section className="w-full max-w-5xl mx-auto section-padding-y">
      <div className="relative bg-[#EBF7FC] dark:bg-zinc-900/40 border-y border-r border-dashed border-[#0091CD] rounded-r-lg pl-6 pr-6 py-8 sm:p-10 md:p-12 overflow-hidden">
