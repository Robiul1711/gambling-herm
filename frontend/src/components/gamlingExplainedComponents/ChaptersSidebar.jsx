...
const ChaptersSidebar = ({ activeSection, onNavigate }) => {
  const navItems = [
    ...
    { id: "chapter-1", label: "1. Gambling and health", isHeader: true },
    {
      ...
      label: "2. Gambling and addiction",
      isHeader: true,
    },
    {
      id: "children-young",
      label: "3. Children and young people",
      isHeader: true,
    },
    { id: "advertising", label: "4. Gambling and advertising", isHeader: true },
    {
      id: "research-education",
      label: "5. Research, education and treatment",
      isHeader: true,
    },
    {
      id: "product-design",
      label: "6. Design of gambling products",
      isHeader: true,
    },
    {
      id: "conducted",
      label: "7. The way gambling is conducted",
      isHeader: true,
    },
    { id: "voluntary-bans", label: "8. Voluntary bans", isHeader: true },
    {
      id: "multinational",
      label: "9. Multinational operators",
      isHeader: true,
    },
