    ...
    >
      ...
      <div className="space-y-2">
        ...
        <p className="text-gray-700 text-base md:text-lg leading-relaxed pt-2">
          Gambling was formally recognised as a mental disorder in DSM-III in
          1980 and reclassified as a behavioural addiction in DSM-5 in 2013, on
          a footing with substance- use disorders. The neurobiology, comorbidity
          profile and treatment response patterns align with that
          classification.
        </p>
      </div>
      ...
      <div className="space-y-3">
        ...
        <p className="text-gray-700 text-sm md:text-base leading-relaxed">
          The{" "}
          <em className="italic">Adult Psychiatric Morbidity Survey 2007</em>{" "}
          (the last APMS to include gambling) reported that adults with gambling
          disorder made a past-year suicide attempt at 4.7%, against 0.6% of
          those without, roughly eight times the rate, and were{" "}
          <strong className="font-bold text-gray-900">
            4.7 times more likely
          </strong>{" "}
          to have had suicidal thoughts (19.2% vs 4.1%). Gambling questions
          returned to the APMS in 2023/4, using the PGSI (published November
          2025); the suicide-attempt analysis has not yet been repeated on the
          new data, and we support it being run and published.
        </p>
      </div>
      ...
      <div className="border border-gray-200 bg-white  p-6 md:p-8 space-y-4">
        ...
        <ol className="list-decimal pl-5 space-y-3 text-xs md:text-sm text-gray-600 leading-relaxed">
          <li>
            American Psychiatric Association. <em className="italic">DSM-5</em>.
            2013.
          </li>
          <li>
          ...
          <li>
            Wardle H et al.{" "}
            <em className="italic">
              Problem gambling and suicidal thoughts, suicide attempts and
          ...
          <li>
            ...
            pathological gambling. <em className="italic">Addiction</em>.
            2011;106(3):490–498.
          </li>
        </ol>
      </div>
