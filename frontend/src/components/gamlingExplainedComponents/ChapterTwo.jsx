...
const ChapterTwo = () => {
  return (
    <div
      ...
      className="space-y-8 scroll-mt-28 border-t border-slate-100 pt-8"
    >
      ...
      <div className="space-y-2">
        ...
        <p className="text-slate-500 text-sm md:text-base leading-relaxed max-w-4xl">
          Gambling addiction was formally recognised as a mental disorder in
          DSM-III in 1980 and reclassified as a behavioural addiction in DSM-5
          in 2013, on a footing with substance-use disorders. The neurobiology,
          comorbidity profile and treatment response patterns align with that
          classification.
        </p>
      </div>
      ...
      <div className="space-y-3">
        <h3 className="text-lg font-bold text-slate-800">Diagnostic framing</h3>
        <p className="text-slate-500 text-sm md:text-base leading-relaxed">
          DSM-5 lists gambling disorder among substance-related and addictive
          disorders. ICD-11 uses"gambling disorder (predominantly online /
          predominantly offline / mixed)". Both require persistent and recurrent
          problematic gambling behaviour leading to clinically significant
          impairment or distress, with criteria covering preoccupation,
          tolerance, withdrawal, loss of control, chasing losses, lying and
      ...
      <div className="space-y-3">
        <h3 className="text-lg font-bold text-slate-800">Comorbidity</h3>
        <p className="text-slate-500 text-sm md:text-base leading-relaxed">
      ...
      <div className="space-y-3">
        <h3 className="text-lg font-bold text-slate-800">Suicidality</h3>
        <p className="text-slate-500 text-sm md:text-base leading-relaxed">
          The Adult Psychiatric Morbidity Survey 2007 (the last APMS to include
          gambling) reported that adults with gambling disorder were 4.7 times
          more likely to have made a past-year suicide attempt than those
          without (4.7% vs 0.6%) and 4.7 times more likely to have had suicidal
          thoughts (19.2% vs 4.1%). This single data point is now seventeen
          years old. We support its restoration in the next APMS.
        </p>
      </div>
      ...
      <div className="border border-slate-200 bg-slate-50/50 p-6 md:p-8 space-y-2">
        ...
        <ol className="list-decimal pl-4 space-y-3 text-xs md:text-sm text-slate-500 marker:text-slate-400 leading-relaxed">
          ...
          <li>
            Wardle H et al. Problem gambling and suicidal thoughts, suicide
            attempts and non-suicidal self-harm. Gambling Commission, 2019.
          </li>
          <li>
            Lorains FK et al. Prevalence of comorbid disorders in problem and
            pathological gambling. Addiction. 2011;106(3):490–498.
          </li>
        </ol>
      </div>
    </div>
