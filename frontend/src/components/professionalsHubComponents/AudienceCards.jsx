...
const AudienceCards = () => {
 ...
 {/* Bottom Button */}
 <div>
 <Link to={card.to} className="inline-flex items-center justify-center gap-2 px-5 py-2.5 bg-[#0a6b94] hover:bg-[#085575] text-white font-medium text-sm transition-colors duration-200 group">
 {card.btnText}
