...
const NoteOnLanguage = () => {
  return (
    <section
      id="language"
      className="bg-[#181818] text-gray-300 py-10 md:py-20"
    >
      <div className="max-w-5xl mx-auto px-4">
        ...
        {/* Intro Narrative */}
        <div className="space-y-5 text-gray-300 text-[14.5px] md:text-base leading-relaxed mb-10 max-w-4xl">
          <p>
            We try to say{" "}
        ...
        <div className="mb-10 space-y-4">
          ...
          <div className="space-y-4 text-gray-300 text-[14.5px] md:text-base leading-relaxed max-w-4xl">
            <p>
        ...
        {/* Dashed Separator */}
        <div className="border-t border-dashed border-gray-700/80 my-6 max-w-4xl"></div>

        {/* Post-separator Paragraph */}
        <p className="text-gray-300 text-[14.5px] md:text-base leading-relaxed mb-10 max-w-4xl">
        ...
        {/* White Position Card */}
        <div className="bg-white border-l-[4px] border-[#1d7092] p-6 md:p-8 rounded-r-xl shadow-md max-w-4xl">
          <h4 className="text-[#1d7092] font-bold text-xs uppercase tracking-wider mb-4">
            OUR POSITION
          </h4>

          <p className="text-[#374151] text-[14.5px] md:text-base leading-relaxed">
