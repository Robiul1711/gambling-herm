...
const WhoIsAffected = () => {
 ...
 {/* Main Title Banner */}
 <h2 className="text-3xl xs:text-4xl md:text-5xl font-bold text-[#2d2d2d] mb-4 tracking-tight">
 6. Who is affected
 </h2>

 <p className="text-[#2d2d2d] text-sm md:text-lg mb-10 md:mb-12">
 ...
 <div className="bg-white border border-gray-200/80 shadow-sm p-6 md:p-8">
 <h3 className="text-xl md:text-2xl font-bold text-[#2d2d2d] mb-6">
 Higher risk
 </h3>
 ...
 <li key={idx} className="py-3 md:py-4 first:pt-0 last:pb-0">
 {text}
 </li>
 ))}
 </ul>
 ...
 <a
 href="#burden-of-harm"
 className="text-[#2d2d2d] underline hover:text-Primary2 transition-colors font-medium"
 >
 ...
 <div className="bg-[#262222] overflow-hidden shadow-xl border-l-[6px] border-Primary2">
 ...
 in some groups, and anyone exposed to a relentlessly-marketed,
