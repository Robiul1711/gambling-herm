...
const GamblingNotNormalProduct = () => {
  return (
    <section
      id="normal-product"
      className="bg-[#181818] text-white py-10 md:py-20"
    >
      <div className="max-w-5xl mx-auto px-4">
        ...
        {/* Heading */}
        <h2 className="text-3xl xs:text-4xl md:text-5xl font-bold leading-tight mb-4 tracking-tight text-white">
          2. Gambling is not a normal product
        </h2>

        {/* Intro */}
        <p className="text-gray-300 text-[15px] md:text-base leading-relaxed mb-10 max-w-4xl">
        ...
        <div className="mb-10 space-y-5">
          ...
          <p className="text-gray-300 text-[14.5px] md:text-base leading-relaxed max-w-4xl">
