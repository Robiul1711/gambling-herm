...
const SaferGamblingMyth = () => {
  return (
    <section id="safer-gambling" className="py-12 md:py-16">
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        ...
        {/* Intro Subtitles */}
        <div className="space-y-4 text-gray-600 text-base sm:text-lg leading-relaxed mb-8 font-normal">
          <p>
        ...
        <div className="bg-[#181818] border-l-[4px] border-[#17a9df] p-6 md:p-8 text-white shadow-md">
          ...
          <p className="text-white font-bold text-sm sm:text-base leading-relaxed">
            ...
            shift blame from product design to personal choice. We don't use it.
            Our preferred frame is public health:{" "}
            <span className="italic font-bold">safer products</span> (not safer
            behaviour);{" "}
            <span className="italic font-bold">marketing restrictions</span>{" "}
            (not awareness campaigns);{" "}
            <span className="italic font-bold">treatment as a right</span> (not
            as a privilege);{" "}
