...
"When the fun stops, stop.""Take time to think.""Stay in control."
 ...
 <div
 key={item.number}
 className="border border-gray-300 p-4 md:p-6 flex flex-col xs:flex-row gap-4 md:gap-5"
 >
 <div className="w-10 h-10 bg-Primary2 text-white flex items-center justify-center font-semibold shrink-0 mt-1">
 {item.number}
 </div>
 ...
 <div className="mt-10 md:mt-12 border border-gray-300 p-5 md:p-8">
...
"When the fun stops, stop. Stay in control. Set deposit limits. Take
 ...
 {/* Our Position Card */}
 <div className="mt-8 md:mt-10 bg-[#262222] overflow-hidden">
