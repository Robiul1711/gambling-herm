  ...
  const missions = [
    {
      ...
      description:
        "Connect anyone affected by gambling themselves or someone they love with accurate information and routes to help, free of industry framing.",
    },
    {
      icon: <Headphones className="w-5 h-5 text-Primary" />,
      title: "Change minds",
      description:
        'Shift the public conversation from "responsible gambling" and individual blame toward a public-health understanding of product, exposure and policy.',
    },
    {
      icon: <BarChart3 className="w-5 h-5 text-Primary" />,
      title: "Change policy",
      description:
        "Push for the regulatory and treatment system the evidence actually supports — independent of gambling-industry funding and influence.",
    ...
    <section className="w-full bg-white py-10 md:py-16">
      <div className="section-padding-x text-center">
        ...
        <p className="text-gray-500 text-sm sm:text-base max-w-2xl mx-auto mb-12 sm:mb-16 leading-relaxed">
          Three things, in this order. Each shaped by the public-health evidence
          on gambling harm, not by industry framings of it.
        </p>
              ...
              {item.link && (
                <div className="pt-6 mt-6 border-t border-gray-50">
                  ...
                  >
                    {item.link.text}
                    <span
                      className="inline-block transform translate-x-1 group-hover:translate-x-2 transition-transform duration-150 ml-1"
                      aria-hidden="true"
                    >
                      &rarr;
                    </span>
