  ...
  return (
    <div className="w-full border-b border-gray-700/40 py-16 md:py-20 text-center px-4 sm:px-6 lg:px-8 bg-[#2A2828] text-white">
      <div className="max-w-6xl mx-auto flex flex-col items-center">
        ...
        {/* 3-Column Info Grid */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-8 lg:gap-12 text-left w-full mb-16">
          
          {/* Column 1: General Enquiries */}
          <div className="space-y-3">
            <h3 className="text-lg font-bold text-gray-200">General Enquiries</h3>
            <a 
            ...
            <p className="text-gray-300 text-sm leading-relaxed pt-2">
              ...
              <Link to="/get-help" className="text-[#38bdf8] hover:underline underline-offset-4">
                our Get Help page
              </Link>
              .
            </p>
          ...
          <div className="space-y-3">
            ...
            <p className="text-gray-300 text-sm leading-relaxed pt-2">
              We aim to respond to UK national press within 4 working hours, others within one 
              working day. Out of hours, please use the same address.
            </p>
          </div>

          {/* Column 3: Partnerships & Research */}
          <div className="space-y-3">
            <h3 className="text-lg font-bold text-gray-200">Partnerships & Research</h3>
            <a 
            ...
            <p className="text-gray-300 text-sm leading-relaxed pt-2">
              For research collaborations, funding (excluding industry sources), and partner 
              organisations.
            </p>
          </div>
        ...
        <div className="max-w-2xl text-center border-t border-gray-700/60 pt-8 w-full">
          <p className="text-gray-400 text-xs sm:text-sm leading-relaxed">
            If you'd like to share your story, please don't include identifying details about other people 
            without their consent. We treat all communications confidentially.
          </p>
        </div>
