...
export default function ThreeFramings() {
  const framings = [
    {
      ...
      description: "Places the responsibility for harm on the individual using the product, away from how the product is designed, marketed and regulated. It is the gambling industry's preferred frame. We use the language of public health: harm, exposure, product safety, regulation, prevention.",
      hasLink: false
    },
    {
      label: "Industry Framing",
      title: "Problem Gambler.",
      description: "Puts the problem inside the person and implies a defective individual interacting with a fine product. The narrow PGSI-8+ definition that produced \"0.4% of UK adults\" radically understates the scale of harm. We say \"people affected by gambling\".",
      hasLink: false
    },
    {
      label: "Industry Framing",
      title: '"Regulation Will Just Push People To The Black Market."',
      description: "The most heavily-deployed industry argument against every meaningful regulatory proposal in the last decade. Empirically, jurisdictions with stricter gambling rules see only marginal black-market substitution, and the comparison is between regulated harm and unregulated harm — not between regulation and no harm.",
  ...
  return (
    <section className="w-full bg-[#FBFBFB] py-16 md:py-24">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        
        {/* Top Header Row Block */}
        <div className="flex flex-col space-y-4 mb-12 text-left">
          ...
          <p className="text-gray-600 text-sm sm:text-base leading-relaxed max-w-2xl font-normal">
            Some language sounds neutral and isn't. The terms below are core to how the gambling industry has shaped 
            public conversation in the UK for thirty years. We don't use any of them.
          </p>
        </div>
