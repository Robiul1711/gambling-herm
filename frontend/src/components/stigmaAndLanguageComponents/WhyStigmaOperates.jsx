...
const stigmaFactors = [
  ...
  },
  {
    ...
    description: (
      <>
        People who face stigma in other parts of their lives, women, minority ethnic groups,
        LGBTQ+ people, people with mental-health conditions, experience compounded gambling-harm
        stigma. See our{" "}
        <Link
