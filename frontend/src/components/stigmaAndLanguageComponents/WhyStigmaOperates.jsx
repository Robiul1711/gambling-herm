  ...
  return (
    <section id="why-stigma" className="py-10 md:py-16">
      <div className="max-w-5xl mx-auto px-4">
        ...
        {/* Main Header Title */}
        <h2 className="text-3xl md:text-4xl font-bold text-[#2d2d2d] leading-tight mb-4 tracking-tight max-w-3xl">
          Why stigma operates this hard in gambling specifically
        </h2>

        {/* Intro Subtitle */}
        <p className="text-[#4b5563] text-[15px] md:text-base mb-10 max-w-3xl leading-relaxed">
          Stigma in gambling has a structure that distinguishes it from alcohol
          or drug stigma.
        </p>

        {/* List Dividers Container */}
        <div className="border-t border-b border-gray-200/80 divide-y divide-gray-200/80">
          {stigmaFactors.map((item, index) => (
            <div
              key={index}
              className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-8 py-6 md:py-7 items-start text-[15px] leading-relaxed"
            >
