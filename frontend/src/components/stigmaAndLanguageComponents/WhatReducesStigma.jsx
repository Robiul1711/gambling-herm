  ...
  return (
    <section id="reduces-stigma" className="py-10 md:py-16 ">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="bg-[#f8f9fa] border-l-[4px] border-[#17a9df] rounded-r-2xl p-6 md:p-8 mb-8 ">
        ...
        <div className="bg-[#262222] rounded-2xl overflow-hidden shadow-xl border-l-[6px] border-[#17a9df]  mb-12">
