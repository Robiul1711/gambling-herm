...
const prompts = [
  {
    ...
    normalText: " was it about something you've been doing yourself, something someone else is doing, or something less specific (worry, money trouble, a relationship strain, a story in the news)?",
  },
  {
  ...
  {
    boldText: "Are you carrying a financial fear, a relational fear, both, or something else?",
    normalText: " Affected others often carry the financial fear before the person who gambles realises there's a problem.",
  },
  {
    ...
    <section id="not-sure" className="py-16 lg:py-24 border-t border-gray-100">
      <div className="max-w-5xl mx-auto px-5">
        ...
        <div className="mt-16">
          ...
          <div className="border-t border-dashed border-[#D2D5DC]">
            {prompts.map((prompt, index) => (
              ...
              >
                <p className="text-[#6E7388] text-base md:text-lg leading-relaxed">
                  <strong className="font-bold text-[#292929]">{prompt.boldText}</strong>
                  {prompt.normalText}
                </p>
              </div>
            ))}
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Card 1 */}
          <div className="border border-[#9EA4B1]/60 bg-white p-6 md:p-8 flex flex-col justify-between hover:shadow-lg transition-shadow duration-300">
            <div>
            ...
            <div className="mt-8">
              <Link
                to="/get-help"
                className="inline-block bg-[#0A6E9C] text-white px-6 py-3.5 font-semibold hover:bg-[#08597d] transition"
              >
                Go To Get Help →
              </Link>
            </div>
