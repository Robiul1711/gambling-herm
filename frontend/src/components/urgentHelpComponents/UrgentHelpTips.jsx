    ...
    <div className="w-full">
      ...
      <div className="bg-[#EBF5FA] py-12 md:py-16 px-4">
        <div className="max-w-3xl mx-auto">
          <div className="bg-white border-2 border-[#82A3A1] rounded-xl md:rounded-2xl p-5 sm:p-8 md:p-10 shadow-sm">
            ...
            <ul className="space-y-5">
              {[
                ...
                <li key={idx} className="flex items-start gap-4 text-sm md:text-base text-gray-700 leading-relaxed">
                  <span className="mt-1.5 w-4 h-4 rounded-full border-2 border-Primary/60 shrink-0" />
                  <span>
      ...
      <div className="bg-gray-50/50 py-12 md:py-16 px-4">
        <div className="max-w-3xl mx-auto">
          <div className="bg-white border border-gray-200 rounded-xl md:rounded-2xl p-5 sm:p-8 md:p-10 shadow-sm">
            ...
            <ul className="space-y-5">
              <li className="flex items-start gap-4 text-sm md:text-base text-gray-700 leading-relaxed">
                <span className="mt-1.5 w-4 h-4 rounded-full border-2 border-Primary/60 shrink-0" />
                <span>
                  <strong>If you believe their life is in immediate danger</strong>, call 999.
                </span>
              </li>
              <li className="flex items-start gap-4 text-sm md:text-base text-gray-700 leading-relaxed">
                <span className="mt-1.5 w-4 h-4 rounded-full border-2 border-Primary/60 shrink-0" />
                <span>
                  <strong>If they will speak to you</strong>, stay with them. Don't leave them alone. Ask them to call Samaritans (116 123). If they want, call together.
                </span>
              </li>
              <li className="flex items-start gap-4 text-sm md:text-base text-gray-700 leading-relaxed">
                <span className="mt-1.5 w-4 h-4 rounded-full border-2 border-Primary/60 shrink-0" />
                <span>
                  <strong>If they won't speak to you</strong>, call Samaritans on 116 123 yourself, and tell them what's happening. They will support <em>you</em>, and help you think about what to do next.
                </span>
              </li>
              <li className="flex items-start gap-4 text-sm md:text-base text-gray-700 leading-relaxed">
                <span className="mt-1.5 w-4 h-4 rounded-full border-2 border-Primary/60 shrink-0" />
                <span>
                  <strong>You don't have to fix it.</strong> You just have to stay. Being there is not a small thing.
                </span>
              </li>
              <li className="flex items-start gap-4 text-sm md:text-base text-gray-700 leading-relaxed">
                <span className="mt-1.5 w-4 h-4 rounded-full border-2 border-Primary/60 shrink-0" />
                <span>
                  After tonight, our <Link to="/get-help/family-friends" className="text-Primary hover:underline font-semibold">family-and-friends page</Link> has practical advice for the days ahead.
                </span>
              </li>
            </ul>
          </div>
