...
"They are gambling in everything but the legal definition, and reach children at scale. Bringing them within scope is overdue.",
 ...
 <div
 key={index}
 className="border border-gray-300 p-6 md:p-8 flex flex-col justify-between hover:border-gray-400 transition-colors duration-200"
 >
 <div>
 ...
 <div className="border border-gray-300 p-6 md:p-8 hover:border-gray-400 transition-colors duration-200">
 <div className="flex items-center gap-2 mb-6">
 <div className="w-5 h-[2px] bg-sky-500"></div>
 <span className="text-xs font-bold text-sky-500 tracking-wider">
 Live Ask
