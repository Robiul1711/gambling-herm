...
const RegulatoryCaptureLobbying = () => {
 ...
 <p>
 The UK gambling regulatory environment has for decades been a
 textbook example of regulatory capture. The policy framework has
 been co-produced by the regulator (the Gambling Commission), the
 sponsoring government department (DCMS), and the major industry
 trade body (the Betting and Gaming Council, and its predecessors) to
 a degree that is unique among high-turnover UK sectors.
 </p>

 <p>
 This capture operates through three mechanisms simultaneously.
 First, the revolving door: senior staff move frequently between the
 regulator, the trade bodies, the industry-funded charities, and the
 operators themselves. Second, information asymmetry: the regulator
 relies almost entirely on operator-supplied data to evaluate product
 risk and customer harm, creating a system where the industry marks
 its own homework. Third, political access: the gambling industry is
 one of the largest sponsors of hospitality, tickets, and APPG events
 in Westminster, purchasing defensive political access at key moments
 in the legislative cycle.
 </p>

 <p>
 The result is a system that responds to industry revenue needs as an
 explicit policy objective, treats revolting-door appointments as
 unremarkable, and views independent public-health data with a
 skepticism it rarely applies to industry projections.
 </p>
 </div>
