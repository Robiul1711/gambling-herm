      ...
      <div className="">
        ...
        <div className="space-y-4 text-sm md:text-base leading-relaxed text-gray-600 mb-10">
          ...
          <p className="text-gray-900">
            ...
            patchy. Marketing remains self-regulated. Affordability checks are
            contested. The political legitimacy of the industry is, in the UK,
            still largely intact. The result is a response that is the wrong
            shape for the burden, weighted at the very end of the harm pipeline,
            where it can change least.
          </p>
        </div>
        ...
        <div className="border-l-4 border-[#166B94] bg-[#292929] text-white p-6 md:p-8 shadow-md">
          ...
          <p className="text-gray-300 text-sm md:text-base leading-relaxed ">
            ...
            on product, on marketing, on availability, on the political
