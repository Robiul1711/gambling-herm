      ...
      <div className="">
        ...
        <div className="space-y-4 text-sm md:text-base leading-relaxed text-gray-600 mb-10 ">
          ...
          <p className="text-gray-400 text-xs md:text-sm">
            Around 9% of UK adults, more than four million people, were affected by someone else's gambling in the past year on the 
            official Gambling Survey for Great Britain (2024), including 2.5% reporting at least one severe consequence; GambleAware's 
            annual survey finds 8.1% (YouGov, 2024). These figures are self-reported, and likely conservative: stigma and hidden 
            gambling mean many affected others never name the harm. Even the most conservative international prevalence estimates 
            put the figure above 2.4 million (Dowling et al., 2025 systematic review).
          </p>
        </div>
