...
const HealthPositionSection = () => {
 ...
 const boldText = sectionData?.subtitle ||"Gambling harm ranks among the top five modifiable risks to UK population health,";
 
 let desc1 ="comparable in burden to alcohol misuse and major depressive disorder. It is currently regulated, funded and addressed as if it were not. That is the central public-health failure we exist to correct.";
 let desc2 ="The framing of gambling harm should match the framing applied to tobacco, alcohol, and ultra-processed food: a commercial determinant of health, governed by a regulator with population-health primacy, funded through a statutory levy scaled to harm, and integrated across the public-health system, not treated as a discretionary leisure issue at the periphery of the regulatory landscape.";
