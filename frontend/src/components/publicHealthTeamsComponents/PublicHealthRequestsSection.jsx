      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex flex-col gap-5">
          {requests.map((item) => (
            <div
              key={item.id}
              className="flex flex-col sm:flex-row items-start bg-white rounded-2xl p-6 md:p-8 gap-4 md:gap-6 shadow-md transition-transform duration-200 hover:-translate-y-[1px]"
            >
