...
const NewsletterBanner = () => {
 ...
 <div className="bg-[#e6f6fe] ] px-6 py-8 sm:px-10 sm:py-10 md:py-12 flex flex-col md:flex-row md:items-center md:justify-between gap-6 md:gap-12">
 {/* Left Side: Content */}
 ...
 className="bg-[#146b93] hover:bg-[#0f5271] text-white font-medium text-[15px] px-[22px] py-[11px] transition-colors duration-200 inline-flex items-center justify-center tracking-wide shrink-0 whitespace-nowrap"
 >
