...
const routes = [
  ...
  text: (
    <>
      the NHS has expanded specialist gambling-harm provision in recent years,
      with clinics across England and additional services in Scotland and Wales.
      Free, evidence-based, you can self-refer.{" "}
      <a
      ...
      <div className="">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
          {routes.map((route) => (
            <div
              key={route.id}
              className="border border-gray-400 rounded-2xl p-5 sm:p-8 bg-white"
            >
