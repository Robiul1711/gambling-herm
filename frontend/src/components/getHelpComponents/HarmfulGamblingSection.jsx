...
const HarmfulGamblingSection = () => {
  return (
      ...
      <div className="max-w-4xl mx-auto section-padding-y">
        ...
        {/* Questions Card */}
        <div className="mt-12 bg-[#e7f2f8] rounded-2xl border-l-4 border-[#0093d0] p-5 sm:p-8 md:p-10">
          ...
          <div className="space-y-0">
            {questions.map((question, index) => (
              ...
              >
                <p className="text-sm sm:text-base md:text-[17px] text-[#333] leading-relaxed md:leading-8">{question}</p>
              </div>
            ))}
            ...
            <div className="pt-5">
              <p className="text-xs sm:text-sm text-[#7a8591] leading-7">
                Adapted from the PGSI, a short clinical screening tool. We use
                it as a reflective prompt, not a diagnostic threshold.
              </p>
            </div>
          </div>
        </div>
        ...
        {/* Bottom Card */}
        <div className="mt-8 bg-[#252223] rounded-2xl border-l-4 border-[#0093d0] p-5 sm:p-8 md:p-10">
          ...
          <div className="space-y-8">
            <p className="text-[#d6d6d6] text-sm sm:text-base md:text-[17px] leading-relaxed md:leading-9">
              UK gambling-prevalence figures have for decades used a PGSI score
              of 8 or above as the cut-off for the most severe band. This
              produces a binary (you either meet that threshold or you don't)
              that the actual evidence on harm does not support. Meaningful
              harm exists well below PGSI 8.
            </p>

            <p className="text-[#d6d6d6] text-sm sm:text-base md:text-[17px] leading-relaxed md:leading-9">
              If your score is lower than 8 but you're worried, your worry is
              the relevant signal, not the score. Please consider talking to
              someone.
            </p>
          </div>
        </div>
