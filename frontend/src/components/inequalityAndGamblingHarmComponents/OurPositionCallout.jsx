  ...
  return (
    <div className="">
      <div className="max-w-5xl mx-auto px-4">
        ...
        <div className="bg-[#edf7fd] border-l-[4px] border-[#17a9df] overflow-hidden">
          <div className="p-8 md:p-10">
            {/* Header Title */}
            <h4 className="text-[#17a9df] text-sm md:text-base font-bold tracking-wider uppercase mb-5">
              OUR POSITION
            </h4>
