...
const ThreeFactorsDistribution = () => {
 ...
 <div
 key={idx}
 className={`p-6 md:p-8 border-gray-200 border min-h-[280px] flex flex-col justify-start bg-white transition-all hover:shadow hover:border-[#17a9df]/70 duration-300`}
 >
