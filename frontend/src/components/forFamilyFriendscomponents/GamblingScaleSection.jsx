...
export default function GamblingScaleSection() {
  ...
  const renderParagraph1 = () => {
    const defaultText =
      "For every person in the UK experiencing severe gambling harm, an estimated six others (partners, parents, children, siblings, close friends) carry significant harm of their own, and by some estimates as many as ten. Around 9% of UK adults, more than four million people, were affected by someone else's gambling in the past year (Gambling Survey for Great Britain official statistics, 2024; GambleAware/YouGov 2024 finds 8.1%). Those figures are self-reported, and if anything conservative. Unlike tobacco or alcohol, around half of all gambling harm is expected to fall on people who never placed a bet.";
