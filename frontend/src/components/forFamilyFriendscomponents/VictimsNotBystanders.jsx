...
export default function VictimsNotBystanders() {
 ...
 const boldPrefix = data?.title ||"Affected Others Are Direct Victims, Not Concerned Bystanders.";
 const mainDesc = data?.description ||"You did not consent to a product being marketed at someone you love. The financial, mental-health and developmental harm to you is not a side-effect of \"someone else's choice\", it is part of the harm the product produced. The UK gambling-harm response routinely understates this. We don't.";
