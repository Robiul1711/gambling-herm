        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="space-y-4">
            {steps.map((step) => (
              <div
                key={step.number}
                className="flex items-start gap-4 sm:gap-6 p-5 sm:p-6 bg-white border border-gray-200 rounded-2xl hover:shadow-sm transition-shadow duration-300"
              >
                {/* Number Badge */}
                <div className="w-10 h-10 rounded-full bg-[#156e94] text-white flex items-center justify-center font-bold text-sm shrink-0 mt-0.5">
                  {step.number}
                </div>
