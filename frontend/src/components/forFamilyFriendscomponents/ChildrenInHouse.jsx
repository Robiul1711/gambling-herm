    ...
    <section className="w-full py-16 md:py-24 bg-white text-[#1f2937] border-b border-gray-100">
      <div className="section-padding-x">
        <div className="max-w-5xl mx-auto">
          ...
          {/* Heading */}
          <h2 className="text-3xl md:text-[34px] font-bold text-[#111827] leading-tight tracking-tight mb-5">
            If there are children in the house
          </h2>

          {/* Subheading / Highlight Paragraph */}
          <p className="text-[15px] sm:text-base leading-relaxed text-[#4b5563] mb-8">
          ...
          <div className="bg-[#222120] text-white border-l-4 border-[#0092D0] rounded-r-2xl p-6 sm:p-8 hover:shadow-md transition-shadow duration-300 text-left">
            <span className="text-[#0092D0] text-xs font-semibold uppercase tracking-wider block mb-3">
              Our position
            </span>
            <p className="text-[14px] sm:text-[15px] leading-relaxed text-gray-300">
