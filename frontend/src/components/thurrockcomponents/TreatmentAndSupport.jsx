      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-[#1f2937]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {treatments.map((item, index) => (
            <div
              key={index}
              className="bg-white border border-gray-150/80 rounded-xl p-5 lg:p-8 shadow-xs flex flex-col justify-between min-h-[220px] hover:shadow-md transition-shadow duration-300"
            >
              <div>
              ...
              <div>
                <a
                  ...
                  className="inline-flex items-center gap-2 bg-[#3F5E6B] hover:bg-[#2F424C] text-white font-semibold text-sm py-3 px-5 rounded-md transition-colors"
                >
                  {item.buttonText}
                  <span>&rarr;</span>
                </a>
          ...
          <div className="bg-white border border-gray-150/80 rounded-xl p-5 lg:p-8 shadow-xs flex flex-col justify-between min-h-[220px] hover:shadow-md transition-shadow duration-300">
            <div>
