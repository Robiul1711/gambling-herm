      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-[#1f2937]">
        ...
        <header className="mb-10">
          ...
          <p className="text-gray-600 text-base md:text-lg leading-relaxed max-w-2xl">
            Talking to people who've been there carries something that other support
            can't. These groups meet regularly in and around Thurrock.
          </p>
        </header>

        {/* Section 1: Gamblers Anonymous */}
        <div className="mb-12">
          <h3 className="text-2xl font-bold text-gray-900 mb-2">Gamblers Anonymous</h3>
          <p className="text-gray-600 text-sm sm:text-base leading-relaxed mb-6">
            Free 12-step meetings for people affected by their own gambling. No commitment to
            stop is required to attend, only a desire to.
          </p>

          <div className="bg-[#EEF7FC] border-l-4 border-[#156E94] rounded-r-xl p-6 md:p-8">
              ...
              {gaMeetings.map((meeting, index) => (
                ...
                >
                  <p className="text-slate-800 text-[15px] leading-relaxed">
                    <strong className="font-bold text-gray-900">{meeting.location}</strong>
                    {meeting.address}
                  </p>
        ...
        {/* Section 2: Gam-Anon */}
        <div>
          <h3 className="text-2xl font-bold text-gray-900 mb-2">Gam-Anon: for affected others</h3>
          <p className="text-gray-600 text-sm sm:text-base leading-relaxed mb-6">
            If you're affected by someone else's gambling, Gam-Anon is for you. Meetings are led by
