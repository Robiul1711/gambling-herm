      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        <div className="bg-[#edf7fd] border-l-[4px] border-[#0093D0]  p-6 sm:p-8 md:p-10 shadow-xs">
          ...
          <p className="text-gray-700 text-base sm:text-lg leading-relaxed font-normal">
            ...
            personal failing in the person experiencing harm. Any account of
            this topic that locates the problem in the individual rather than
            the product misreads the evidence.
          </p>
        </div>
      </div>
    </section>
