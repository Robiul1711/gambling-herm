      ...
      <div className="">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 items-stretch">
          {proposals.map((proposal) => (
            <div 
              key={proposal.id} 
              className="border border-gray-200 rounded-3xl p-6 md:p-8 bg-white shadow-sm hover:shadow-md transition-all duration-300 flex flex-col justify-between"
            >
              {/* Card Body Details */}
              <div>
              ...
              <div>
                <button className="inline-flex items-center justify-center bg-[#166B94] hover:bg-[#0076A8] text-white font-medium text-xs md:text-sm px-5 py-3 rounded-xl transition-all duration-150 group">
                  Proposal Details
