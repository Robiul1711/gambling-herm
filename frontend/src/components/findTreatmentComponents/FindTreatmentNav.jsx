            ...
            {tabs.map(({ id, label }) => {
              ...
              return (
                <button
                  ...
                  className={`shrink-0 snap-center whitespace-nowrap px-4 py-2 rounded-full text-xs sm:text-sm font-medium border transition-all duration-200 cursor-pointer ${
                    isActive
