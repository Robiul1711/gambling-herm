      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="border-l-4 border-Primary pl-6 md:pl-10 flex flex-col space-y-4 md:space-y-6">
          ...
          <div className="flex flex-col space-y-4 text-gray-300 text-sm sm:text-base md:text-lg leading-relaxed max-w-3xl font-normal">
            <p>
              The product. The marketing. The regulatory environment. The funding for treatment and research. 
              Every one of those is changeable. The harm is preventable. The reason it persists at the scale 
              it does is not mystery, weak willpower, or a &quot;vulnerable few&quot;. It is a policy choice.
            </p>
